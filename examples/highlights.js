window.onload = function () {
        ...
        for (i = 0; i < coll.length; i++) {
            ...
            var draft = document.getElementById("story-draft");
            var lines = draft.innerHTML.split("<br>");
            var plain_lines = document.getElementById("story-draft-plain").innerHTML.split("<br>");
            ...
            var draft = document.getElementById("story-draft");
            var lines = draft.innerHTML.split("<br>")
            var highlighted_lines = document.getElementById("story-draft-highlighted").innerHTML.split("<br>");
            var matched_inst = document.getElementById("matched-instructions").innerHTML.split("<br>");
            var options = content.innerHTML.split("<br>");
            var updated = "";
